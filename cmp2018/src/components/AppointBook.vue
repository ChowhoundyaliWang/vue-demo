		...
		<div class="page-content">
			<el-card class="box-card mb-16 inp-middle" shadow="always">
				...
				<el-form label-width="120px">
					...
					<el-form-item label="项目号修正"> 
						<span>{{appointBook.projectNo}}</span>
					</el-form-item>
			...
			<el-card class="box-card mb-16" shadow="always" v-if='!viewFlag'>
				...
				<el-table :data="appointBook.proManagerTable" border class="mx-table tb-inp">
					...
					<el-table-column prop="proManager" label="拟任命项目经理" width='120px'>
					    <template slot-scope='scope'>
							<el-input v-model='scope.row.proManager'></el-input>
						</template>  
					</el-table-column>
					<el-table-column prop="isPractice" label="是否实习">
					    <template slot-scope='scope'>
					...
					<el-table-column prop="email" label="电子邮箱地址" width="180px">
					    <template slot-scope='scope'>
			...
			<el-card class="box-card mb-16" shadow="always" v-if='viewFlag'>
				...
				<el-table :data="appointBook.proManagerTable" border class="mx-table tb-inp">
					...
					<el-table-column prop="proManager" label="拟任命项目经理" width='120'></el-table-column>
					<el-table-column prop="isPractice" label="是否实习"></el-table-column>
					<el-table-column prop="isWork" label="是否劳务"></el-table-column>
					<el-table-column prop="email" label="电子邮箱地址" width="180px"></el-table-column>
					<el-table-column prop="startTime" label="任命开始时间" width='180'>
					    <template slot-scope='scope'>
			...
			<el-card class="box-card mb-16 inp-middle" shadow="always">
				...
				<el-form label-width="120px">
					...
					<el-form-item label="工作内容">
						<el-input type='textarea' :rows='8' style="width: 70%;" v-model='appointBook.workContent' readOnly></el-input>
					</el-form-item>
					<el-form-item label="工作界面">
						<el-input type='textarea' :rows='8' style="width: 70%;" v-model='appointBook.workspace' readOnly></el-input>
					</el-form-item>
					<el-form-item label="备注">
						<el-input type='textarea' :rows='8' style="width: 70%;" v-model='appointBook.workRemark' readOnly></el-input>
					</el-form-item>
