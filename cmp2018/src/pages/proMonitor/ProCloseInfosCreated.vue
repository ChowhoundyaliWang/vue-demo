	...
	<div>
		<div class="page-title mb-16">
			<el-breadcrumb separator="/">
				...
				<el-breadcrumb-item>已创建的项目关闭通知</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<div class="page-content">
			<el-card class="box-card mb-16" shadow="always">
				...
				<el-table :data="tableData" stripe border class="mb-16">
					...
					<el-table-column prop="createTime" label="项目结束时间" width='170px' show-overflow-tooltip> 
					</el-table-column>
					<el-table-column prop="auditResult" label="创建人" show-overflow-tooltip> 
					</el-table-column>
					<el-table-column prop="auditor" label="创建时间" width='170px' show-overflow-tooltip> 
					</el-table-column>
				</el-table>
				<div>
