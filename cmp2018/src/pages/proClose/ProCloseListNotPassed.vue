	...
	<div>
		<div class="page-title mb-16">
			<el-breadcrumb separator="/">
				...
				<el-breadcrumb-item>未通过的项目关闭单</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
...
<script>
export default {
	name: 'ProCloseListNotPassed',
	data () {
		return {
			searchUrl: '/api/projectBudget/list?status=4',
			tableData:{
				data:[],
				totalNum:0,
			    pageNum:0,
	...
	methods:{
		...
		handleView(index,row){
            ...
            this.$router.push({
            	name:'CloseListModify', params:{ id: curId}
            })
		},
		// 翻页 表格当前页码改变触发事件
