			...
			<el-card class="box-card mb-16 inp-middle" shadow="always">
				...
				<el-form label-width="120px">
					<el-form-item label="项目进度">
						<el-input type='textarea' :rows='4' style="width: 40%;" v-model='planBook.projectSchedule'></el-input>
					</el-form-item>
					<el-form-item label="项目要求">
						<el-input type='textarea' :rows='4' style="width: 40%;" v-model='planBook.projectDemand'></el-input>
					</el-form-item>
					<el-form-item label="项目资源">
						<el-input type='textarea' :rows='4' style="width: 40%;" v-model='planBook.projectResource'></el-input>
					</el-form-item>
				</el-form>	
			</el-card>
			<el-card class="box-card mb-16" shadow="always">
				...
				<el-table :data="planBook.personalAllocation" border style="width:80%;" class="mx-table tb-inp">
					...
					<el-table-column prop="endTime" label="参与周期结束" width='180'>
					    <template slot-scope='scope'>
							<el-date-picker v-model='scope.row.endTime' type='date' placeholder="结束日期" format='yyyy-MM-dd' value-format='yyyy-MM-dd'></el-date-picker>
						</template>  
					</el-table-column>
	...
	mounted (){
		...
		this.axios.get('/api/planPaper/get-quality-goal/list').then((res)=>{
			...
			if(data.code == 200){
				...
				this.planBook.qualityTarget = data.model;
			}
		});
